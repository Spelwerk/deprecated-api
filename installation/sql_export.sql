...
CREATE TABLE IF NOT EXISTS `spelwerk`.`world` (
  ...
  `consumable_attributetype_id` INT NOT NULL,
  `finance_attributetype_id` INT NOT NULL,
  `skill_attributetype_id` INT NOT NULL,
  `supernatural_attributetype_id` INT NULL,
  `hitpoints_attributetype_id` INT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_setting_attributetype1_idx` (`supernatural_attributetype_id` ASC),
  INDEX `fk_setting_attributetype2_idx` (`skill_attributetype_id` ASC),
  INDEX `fk_world_attributetype1_idx` (`hitpoints_attributetype_id` ASC),
  INDEX `fk_world_attributetype2_idx` (`consumable_attributetype_id` ASC),
  INDEX `fk_world_attributetype3_idx` (`finance_attributetype_id` ASC),
  CONSTRAINT `fk_setting_attributetype1`
    FOREIGN KEY (`supernatural_attributetype_id`)
  ...
  CONSTRAINT `fk_world_attributetype1`
    FOREIGN KEY (`hitpoints_attributetype_id`)
    REFERENCES `spelwerk`.`attributetype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_attributetype2`
    FOREIGN KEY (`consumable_attributetype_id`)
    REFERENCES `spelwerk`.`attributetype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_attributetype3`
    FOREIGN KEY (`finance_attributetype_id`)
    REFERENCES `spelwerk`.`attributetype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
