...
-- -----------------------------------------------------
-- Table `spelwerk`.`usertoken`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`usertoken` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`usertoken` (
  `token` VARCHAR(256) NOT NULL,
  `user_id` INT NOT NULL,
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`token`),
  UNIQUE INDEX `token_UNIQUE` (`token` ASC),
  INDEX `fk_usertoken_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_usertoken_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `spelwerk`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`useraccess`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`useraccess` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`useraccess` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  `description` TEXT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `spelwerk`.`user_has_useraccess`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`user_has_useraccess` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`user_has_useraccess` (
  `user_id` INT NOT NULL,
  `useraccess_id` INT NOT NULL,
  PRIMARY KEY (`user_id`, `useraccess_id`),
  INDEX `fk_user_has_useraccess_useraccess1_idx` (`useraccess_id` ASC),
  INDEX `fk_user_has_useraccess_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_user_has_useraccess_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `spelwerk`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_has_useraccess_useraccess1`
    FOREIGN KEY (`useraccess_id`)
    REFERENCES `spelwerk`.`useraccess` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
