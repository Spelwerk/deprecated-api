...
CREATE TABLE IF NOT EXISTS `spelwerk`.`setting` (
  ...
  `affliction` TINYINT(1) NOT NULL COMMENT 'Affliction Exists',
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`person` (
  ...
  `afflicted` TINYINT(1) NOT NULL COMMENT 'Is Afflicted',
  `age` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `spelwerk`.`permissions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`permissions` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`permissions` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  `description` TEXT NULL,
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
-- Table `spelwerk`.`pagetype`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`pagetype` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`pagetype` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  `description` TEXT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_pagetype_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_pagetype_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `spelwerk`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `spelwerk`.`page`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`page` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`page` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `spelwerk`.`news`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`news` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`news` (
