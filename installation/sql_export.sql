...
CREATE TABLE IF NOT EXISTS `spelwerk`.`species` (
  ...
  `multiply_skill` INT NOT NULL,
  `multiply_expertise` INT NOT NULL,
  `icon_id` INT NULL,
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` DATETIME NULL,
  `updated` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`world` (
  ...
  `money_attribute_id` INT NOT NULL,
  ...
  INDEX `fk_world_attribute1_idx` (`money_attribute_id` ASC),
  ...
  CONSTRAINT `fk_world_expertisetype2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_attribute1`
    FOREIGN KEY (`money_attribute_id`)
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`manifestation` (
  ...
  `power_attribute_id` INT NOT NULL,
  `icon_id` INT NULL,
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` DATETIME NULL,
  `updated` DATETIME NULL,
  ...
  INDEX `fk_manifestation_attribute1_idx` (`power_attribute_id` ASC),
  ...
  CONSTRAINT `fk_manifestation_attribute1`
    FOREIGN KEY (`power_attribute_id`)
    REFERENCES `spelwerk`.`attribute` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`person` (
  ...
  `point_supernatural` INT NULL,
  `point_power` INT NULL,
  `point_money` INT NULL,
  `point_skill` INT NULL,
  `point_expertise` INT NULL,
  `point_milestone_upbringing` INT NULL,
  `point_milestone_flexible` INT NULL,
  `point_characteristic_gift` INT NULL,
  `point_characteristic_imperfection` INT NULL,
  `point_relationship` INT NULL,
  `world_id` INT NOT NULL,
