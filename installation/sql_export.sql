...
CREATE TABLE IF NOT EXISTS `spelwerk`.`world` (
  ...
  `supernatural_split` INT NOT NULL,
  `supernatural_attributetype_id` INT NOT NULL,
  `augmentation` TINYINT(1) NOT NULL COMMENT 'Augmentation Exists',
  `skill_split` INT NOT NULL,
  `skill_attributetype_id` INT NOT NULL,
  `expertise_split` INT NOT NULL,
  `milestone_split` INT NOT NULL,
  `relationship_split` INT NOT NULL,
  `timeline_split` INT NOT NULL,
  `characteristic_max` INT NOT NULL,
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` DATETIME NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
