...
CREATE TABLE IF NOT EXISTS `spelwerk`.`expertisetype` (
  ...
  `skill_attribute_required` INT NOT NULL,
  `skill_attribute_increment` INT NOT NULL,
  `startsat` INT NULL,
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` DATETIME NULL,
  `updated` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`world` (
  ...
  `bionic` TINYINT(1) NOT NULL,
  `augmentation` TINYINT(1) NOT NULL COMMENT 'Augmentation Exists',
  `software` TINYINT(1) NOT NULL,
  `supernatural` TINYINT(1) NOT NULL COMMENT 'Affliction Exists',
  `supernatural_name` VARCHAR(64) NULL,
  `skill_attributetype_id` INT NOT NULL,
  `attribute_expertisetype_id` INT NOT NULL,
  `dice_expertisetype_id` INT NOT NULL,
  `split_supernatural` INT NOT NULL,
  `split_skill` INT NOT NULL,
  `split_expertise` INT NOT NULL,
  `split_milestone` INT NOT NULL,
  `split_relationship` INT NOT NULL,
  `split_timeline` INT NOT NULL,
  `max_characteristic_gift` INT NOT NULL,
  `max_characteristic_imperfection` INT NOT NULL,
  `max_supernatural` INT NOT NULL,
  `max_skill` INT NOT NULL,
  `max_expertise` INT NOT NULL,
  `max_milestone_upbringing` INT NOT NULL,
  `max_milestone_flexible` INT NOT NULL,
  `max_relationship` INT NOT NULL,
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` DATETIME NULL,
  `updated` DATETIME NULL,
  PRIMARY KEY (`id`),
  ...
  INDEX `fk_world_attributetype1_idx` (`skill_attributetype_id` ASC),
  INDEX `fk_world_expertisetype1_idx` (`attribute_expertisetype_id` ASC),
  INDEX `fk_world_expertisetype2_idx` (`dice_expertisetype_id` ASC),
  CONSTRAINT `fk_world_attributetype1`
    FOREIGN KEY (`skill_attributetype_id`)
    REFERENCES `spelwerk`.`attributetype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_expertisetype1`
    FOREIGN KEY (`attribute_expertisetype_id`)
    REFERENCES `spelwerk`.`expertisetype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_expertisetype2`
    FOREIGN KEY (`dice_expertisetype_id`)
    REFERENCES `spelwerk`.`expertisetype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`species` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_species_icon1_idx` (`icon_id` ASC),
  CONSTRAINT `fk_species_icon1`
    FOREIGN KEY (`icon_id`)
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`attribute` (
  ...
  INDEX `fk_attribute_icon1_idx` (`icon_id` ASC),
  INDEX `fk_attribute_species1_idx` (`species_id` ASC),
  CONSTRAINT `fk_attribute_attributetype1`
    FOREIGN KEY (`attributetype_id`)
    REFERENCES `spelwerk`.`attributetype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_attribute_icon1`
    FOREIGN KEY (`icon_id`)
    REFERENCES `spelwerk`.`icon` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_attribute_species1`
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`manifestation` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_manifestation_icon1_idx` (`icon_id` ASC),
  INDEX `fk_manifestation_attributetype1_idx` (`attributetype_id` ASC),
  INDEX `fk_manifestation_expertisetype1_idx` (`expertisetype_id` ASC),
  CONSTRAINT `fk_manifestation_icon1`
    FOREIGN KEY (`icon_id`)
    REFERENCES `spelwerk`.`icon` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_manifestation_attributetype1`
    FOREIGN KEY (`attributetype_id`)
    REFERENCES `spelwerk`.`attributetype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_manifestation_expertisetype1`
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`person` (
  ...
  `supernatural` TINYINT(1) NOT NULL COMMENT 'Is Afflicted',
  `age` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`characteristic` (
  ...
  INDEX `fk_characteristic_icon1_idx` (`icon_id` ASC),
  ...
  CONSTRAINT `fk_characteristic_attribute1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_characteristic_icon1`
    FOREIGN KEY (`icon_id`)
    REFERENCES `spelwerk`.`icon` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`milestone` (
  ...
  `caste_id` INT NULL COMMENT 'Requires Caste',
  `species_id` INT NULL,
  `manifestation_id` INT NULL,
  `attribute_id` INT NULL COMMENT 'Gives Attribute',
  `attribute_value` INT NULL COMMENT 'Gives Attribute Value',
  `loyalty_id` INT NULL COMMENT 'Gives Relationship (and loyalty bonus)',
  `loyalty_occupation` VARCHAR(64) NULL,
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` DATETIME NULL,
  `updated` DATETIME NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`expertise` (
  ...
  INDEX `fk_expertise_weapon1_idx` (`weapon_id` ASC),
  ...
  CONSTRAINT `fk_expertise_attribute2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_expertise_weapon1`
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`user` (
  ...
  `verified_hash` VARCHAR(32) NULL,
  `recovery` VARCHAR(32) NULL,
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` DATETIME NULL,
  `updated` DATETIME NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `spelwerk`.`world_has_caste`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`world_has_caste` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`world_has_caste` (
  `world_id` INT NOT NULL,
  `caste_id` INT NOT NULL,
  PRIMARY KEY (`world_id`, `caste_id`),
  INDEX `fk_world_has_caste_caste1_idx` (`caste_id` ASC),
  INDEX `fk_world_has_caste_world1_idx` (`world_id` ASC),
  CONSTRAINT `fk_world_has_caste_world1`
    FOREIGN KEY (`world_id`)
    REFERENCES `spelwerk`.`world` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_has_caste_caste1`
    FOREIGN KEY (`caste_id`)
    REFERENCES `spelwerk`.`caste` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`world_has_nature`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`world_has_nature` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`world_has_nature` (
  `world_id` INT NOT NULL,
  `nature_id` INT NOT NULL,
  PRIMARY KEY (`world_id`, `nature_id`),
  INDEX `fk_world_has_nature_nature1_idx` (`nature_id` ASC),
  INDEX `fk_world_has_nature_world1_idx` (`world_id` ASC),
  CONSTRAINT `fk_world_has_nature_world1`
    FOREIGN KEY (`world_id`)
    REFERENCES `spelwerk`.`world` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_has_nature_nature1`
    FOREIGN KEY (`nature_id`)
    REFERENCES `spelwerk`.`nature` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`world_has_identity`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`world_has_identity` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`world_has_identity` (
  `world_id` INT NOT NULL,
  `identity_id` INT NOT NULL,
  PRIMARY KEY (`world_id`, `identity_id`),
  INDEX `fk_world_has_identity_identity1_idx` (`identity_id` ASC),
  INDEX `fk_world_has_identity_world1_idx` (`world_id` ASC),
  CONSTRAINT `fk_world_has_identity_world1`
    FOREIGN KEY (`world_id`)
    REFERENCES `spelwerk`.`world` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_has_identity_identity1`
    FOREIGN KEY (`identity_id`)
    REFERENCES `spelwerk`.`identity` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`world_has_focus`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`world_has_focus` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`world_has_focus` (
  `world_id` INT NOT NULL,
  `focus_id` INT NOT NULL,
  PRIMARY KEY (`world_id`, `focus_id`),
  INDEX `fk_world_has_focus_focus1_idx` (`focus_id` ASC),
  INDEX `fk_world_has_focus_world1_idx` (`world_id` ASC),
  CONSTRAINT `fk_world_has_focus_world1`
    FOREIGN KEY (`world_id`)
    REFERENCES `spelwerk`.`world` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_has_focus_focus1`
    FOREIGN KEY (`focus_id`)
    REFERENCES `spelwerk`.`focus` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`world_has_characteristic`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`world_has_characteristic` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`world_has_characteristic` (
  `world_id` INT NOT NULL,
  `characteristic_id` INT NOT NULL,
  PRIMARY KEY (`world_id`, `characteristic_id`),
  INDEX `fk_world_has_characteristic_characteristic1_idx` (`characteristic_id` ASC),
  INDEX `fk_world_has_characteristic_world1_idx` (`world_id` ASC),
  CONSTRAINT `fk_world_has_characteristic_world1`
    FOREIGN KEY (`world_id`)
    REFERENCES `spelwerk`.`world` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_has_characteristic_characteristic1`
    FOREIGN KEY (`characteristic_id`)
    REFERENCES `spelwerk`.`characteristic` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`world_has_augmentation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`world_has_augmentation` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`world_has_augmentation` (
  `world_id` INT NOT NULL,
  `augmentation_id` INT NOT NULL,
  PRIMARY KEY (`world_id`, `augmentation_id`),
  INDEX `fk_world_has_augmentation_augmentation1_idx` (`augmentation_id` ASC),
  INDEX `fk_world_has_augmentation_world1_idx` (`world_id` ASC),
  CONSTRAINT `fk_world_has_augmentation_world1`
    FOREIGN KEY (`world_id`)
    REFERENCES `spelwerk`.`world` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_has_augmentation_augmentation1`
    FOREIGN KEY (`augmentation_id`)
    REFERENCES `spelwerk`.`augmentation` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`unarmed`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`unarmed` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`unarmed` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  `description` TEXT NULL,
  `hidden` TINYINT(1) NOT NULL,
  ...
  `initiative` INT NOT NULL,
  `hit` INT NOT NULL,
  `skill_attribute_id` INT NOT NULL,
  `damage_attribute_id` INT NOT NULL,
  `expertise_id` INT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_unarmed_attribute1_idx` (`skill_attribute_id` ASC),
  INDEX `fk_unarmed_attribute2_idx` (`damage_attribute_id` ASC),
  INDEX `fk_unarmed_expertise1_idx` (`expertise_id` ASC),
  INDEX `fk_unarmed_icon1_idx` (`icon_id` ASC),
  CONSTRAINT `fk_unarmed_attribute1`
    FOREIGN KEY (`skill_attribute_id`)
    REFERENCES `spelwerk`.`attribute` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_unarmed_attribute2`
    FOREIGN KEY (`damage_attribute_id`)
    REFERENCES `spelwerk`.`attribute` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_unarmed_expertise1`
    FOREIGN KEY (`expertise_id`)
    REFERENCES `spelwerk`.`expertise` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_unarmed_icon1`
    FOREIGN KEY (`icon_id`)
    REFERENCES `spelwerk`.`icon` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`species_has_unarmed`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`species_has_unarmed` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`species_has_unarmed` (
  `species_id` INT NOT NULL,
  `unarmed_id` INT NOT NULL,
  PRIMARY KEY (`species_id`, `unarmed_id`),
  INDEX `fk_species_has_unarmed_unarmed1_idx` (`unarmed_id` ASC),
  INDEX `fk_species_has_unarmed_species1_idx` (`species_id` ASC),
  CONSTRAINT `fk_species_has_unarmed_species1`
    FOREIGN KEY (`species_id`)
    REFERENCES `spelwerk`.`species` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_species_has_unarmed_unarmed1`
    FOREIGN KEY (`unarmed_id`)
    REFERENCES `spelwerk`.`unarmed` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `spelwerk`.`npc_has_unarmed`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`npc_has_unarmed` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`npc_has_unarmed` (
  `npc_id` INT NOT NULL,
  `unarmed_id` INT NOT NULL,
  PRIMARY KEY (`npc_id`, `unarmed_id`),
  INDEX `fk_npc_has_unarmed_unarmed1_idx` (`unarmed_id` ASC),
  INDEX `fk_npc_has_unarmed_npc1_idx` (`npc_id` ASC),
  CONSTRAINT `fk_npc_has_unarmed_npc1`
    FOREIGN KEY (`npc_id`)
    REFERENCES `spelwerk`.`npc` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_npc_has_unarmed_unarmed1`
    FOREIGN KEY (`unarmed_id`)
    REFERENCES `spelwerk`.`unarmed` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`person_has_unarmed` (
  ...
  INDEX `fk_person_has_unarmed_unarmed1_idx` (`unarmed_id` ASC),
  ...
  CONSTRAINT `fk_person_has_unarmed_person1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_person_has_unarmed_unarmed1`
    FOREIGN KEY (`unarmed_id`)
    REFERENCES `spelwerk`.`unarmed` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`world_has_unarmed`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`world_has_unarmed` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`world_has_unarmed` (
  `world_id` INT NOT NULL,
  `unarmed_id` INT NOT NULL,
  PRIMARY KEY (`world_id`, `unarmed_id`),
  INDEX `fk_world_has_unarmed_unarmed1_idx` (`unarmed_id` ASC),
  INDEX `fk_world_has_unarmed_world1_idx` (`world_id` ASC),
  CONSTRAINT `fk_world_has_unarmed_world1`
    FOREIGN KEY (`world_id`)
    REFERENCES `spelwerk`.`world` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_world_has_unarmed_unarmed1`
    FOREIGN KEY (`unarmed_id`)
    REFERENCES `spelwerk`.`unarmed` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`companion_has_unarmed` (
  ...
  INDEX `fk_companion_has_unarmed_unarmed1_idx` (`unarmed_id` ASC),
  ...
  CONSTRAINT `fk_companion_has_unarmed_companion1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_companion_has_unarmed_unarmed1`
    FOREIGN KEY (`unarmed_id`)
    REFERENCES `spelwerk`.`unarmed` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `spelwerk`.`behaviour`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`behaviour` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`behaviour` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC))
...
-- -----------------------------------------------------
-- Table `spelwerk`.`appearance`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`appearance` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`appearance` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC))
...
-- -----------------------------------------------------
-- Table `spelwerk`.`feature`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`feature` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`feature` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC))
...
-- -----------------------------------------------------
-- Table `spelwerk`.`personality`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`personality` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`personality` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC))
