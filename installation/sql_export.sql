...
CREATE TABLE IF NOT EXISTS `spelwerk`.`nature` (
  ...
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` DATETIME NULL,
  `give_attribute_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_nature_attribute1_idx` (`give_attribute_id` ASC),
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`identity` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_identity_attribute1_idx` (`give_attribute_id` ASC),
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`focus` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_focus_attribute1_idx` (`give_attribute_id` ASC),
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`characteristic` (
  ...
  `species_id` INT NULL,
  `manifestation_id` INT NULL,
  `give_attribute_id` INT NULL,
  `give_attribute_value` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_characteristic_species1_idx` (`species_id` ASC),
  INDEX `fk_characteristic_manifestation1_idx` (`manifestation_id` ASC),
  INDEX `fk_characteristic_attribute1_idx` (`give_attribute_id` ASC),
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`milestone` (
  ...
  `give_attribute_id` INT NULL,
  `give_attribute_value` INT NULL,
  `give_loyalty_id` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_milestone_caste1_idx` (`caste_id` ASC),
  INDEX `fk_milestone_attribute1_idx` (`give_attribute_id` ASC),
  INDEX `fk_milestone_loyalty1_idx` (`give_loyalty_id` ASC),
...
-- -----------------------------------------------------
-- Table `spelwerk`.`relationship`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`relationship` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`relationship` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  `description` TEXT NULL,
  `occupation` VARCHAR(64) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_relationship_setting1_idx` (`setting_id` ASC),
  CONSTRAINT `fk_relationship_setting1`
    FOREIGN KEY (`setting_id`)
    REFERENCES `spelwerk`.`setting` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`augmentation` (
  ...
  `give_attribute_id` INT NULL,
  `give_attribute_value` INT NULL,
  `give_weapon_id` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_augmentation_bionic1_idx` (`bionic_id` ASC),
  INDEX `fk_augmentation_weapon1_idx` (`give_weapon_id` ASC),
  INDEX `fk_augmentation_attribute1_idx` (`give_attribute_id` ASC),
...
CREATE TABLE IF NOT EXISTS `spelwerk`.`protection` (
  ...
  `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted` DATETIME NULL,
  `protectiontype_id` INT NOT NULL,
  `attribute_id` INT NOT NULL,
  `attribute_value` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_protection_attribute1_idx` (`attribute_id` ASC),
  INDEX `fk_protection_protectiontype1_idx` (`protectiontype_id` ASC),
  CONSTRAINT `fk_protection_attribute1`
    FOREIGN KEY (`attribute_id`)
    REFERENCES `spelwerk`.`attribute` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `spelwerk`.`person_has_relationship`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spelwerk`.`person_has_relationship` ;

CREATE TABLE IF NOT EXISTS `spelwerk`.`person_has_relationship` (
  `person_id` INT NOT NULL,
  `relationship_id` INT NOT NULL,
  `loyalty_id` INT NOT NULL,
  `deleted` DATETIME NULL,
  PRIMARY KEY (`person_id`, `relationship_id`),
  INDEX `fk_person_has_relationship_relationship1_idx` (`relationship_id` ASC),
  INDEX `fk_person_has_relationship_person1_idx` (`person_id` ASC),
  INDEX `fk_person_has_relationship_loyalty1_idx` (`loyalty_id` ASC),
  ...
  CONSTRAINT `fk_person_has_relationship_relationship1`
    ...
    REFERENCES `spelwerk`.`relationship` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_person_has_relationship_loyalty1`
